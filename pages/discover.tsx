      ...
      <CardContent>
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="w-full lg:w-1/3 flex flex-col items-center justify-center text-center">
            <p>
            Founded in 2023 by Kenyan designer Lydia Waka, WakaWears is a clothing brand deeply inspired by arts, global cultures, and the natural beauty of Africa. Rooted in creativity and cultural pride, WakaWears showcases designs that combine bold colors, modern aesthetics, and elements that celebrate Kenya&apos;s rich heritage.
            </p>
            <p>
            Lydia Waka, passionate about design and the arts, cultivated her skills in fashion and tailoring from a young age. Her vision for WakaWears was clear: to create an African-owned fashion brand that speaks to adventurers in spirit, style, and substance. By embracing innovative designs, retro-classic silhouettes, and contemporary femininity, WakaWears appeals to individuals who value authenticity and bold expression.
            </p>
            <p>
