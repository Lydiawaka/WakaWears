...
const products = [
  { id: 1, name: 'Khamrah by Lattafa Perfumes', price: 'Ksh. 4500', image: '/images/Beauty/lkharwah.jpg' },
  ...
  { id: 10, name: 'Hair claws', price: 'Ksh. 900', image: '/images/Beauty/claw.jpeg' },
];
